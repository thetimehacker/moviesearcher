...
<div class="sidebar">
  <a class="active" href="searchmovie.php">All Movies</a>
    ...
    <div class="col-sm-12">
      ...
      <div class="admin_tick" style="text-align: left;margin-bottom: 20px;">
        ...
        <?php
          ...
          $check=$db->prepare('SELECT * FROM moviesearch where (flag=0 or flag=?)');
                  ...
                  <td><?php
                    ...
                    ?>
                      ...
                      <button
                        ...
                        padding: 0px 10px;
                        color: white;
                        margin: 10px;">Publicly available</button></td>
