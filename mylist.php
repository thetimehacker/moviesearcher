...
<div class="sidebar">
  ...
  <a class="active" href="mylist.php">My list</a>  
    ...
    <div class="col-sm-12">
      ...
      <div class="admin_tick" style="text-align: left;margin-bottom: 20px;">
        <div class="admin_heading" style="margin-bottom: 20px;">
          <h1 style="text-align: center;">My Added Movies</h1>
        </div>
        <!-- //create php  -->
        ...
        <?php
          ...
          $check=$db->prepare('SELECT * FROM moviesearch where flag=?');
              ...
              <tr>
                  ...
                  <td>
                    <?php
                      if($datarow['public']==0){
                        ?>
                              <button onclick="change(<?php echo $datarow['mid'] ?>)" 
                              ...
                              padding: 0px 10px;
                              color: white;
                              margin: 10px;">Make it private</button>
                    <?php
                      }
                      else{
                        ?>
                              ...
                              padding: 0px 10px;
                              color: white;
                              margin: 10px;">Make it public</button>
                      <?php
                      }
                      ?>
                  </td>
      ...
      $.ajax(
      {
        ...
        success:function(data){
          if(data==0){
            ...
            open("mylist.php","_self"); //refresh the page
